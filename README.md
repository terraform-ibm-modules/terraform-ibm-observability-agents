...
| <a name="input_logdna_add_cluster_name_as_tag"></a> [logdna\_add\_cluster\_name\_as\_tag](#input\_logdna\_add\_cluster\_name\_as\_tag) | If true, configure the logdna agent to attach a tag containing the cluster name to all log messages. | `bool` | `true` | no |
