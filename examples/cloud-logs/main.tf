...
module "observability_agents" {
  ...
  logs_routing_enable_direct_to_cloud_logs = true
  cloud_logs_target_host                   = module.observability_instance.cloud_logs_ingress_private_endpoint
  cloud_logs_target_port                   = 443
}
